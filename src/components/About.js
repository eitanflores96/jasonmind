...
const About = () => {
  const texts = [
    ...
    "With an uprising career, Jason has shared the booth with international artists like Adriatique, Colyn, Stephan Jolk, Maz, Antdot, Arodes, Nandu, Sparrow & Barbossa, MoBlack, Technasia, ID ID, as well as national talents such as Øostil, Brigado Crew, Bob Tosh, This&That, NonCitizens, Marcelo Vasami, John Cosani, Fernando Ferreyra, Nim, Matias Sundblad, Muter, FrancoBA, KeyCity, and many others."
